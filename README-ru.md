...
> [!NOTE]
> Для развёртываний с доступом из интернета используйте [обратный прокси](#использование-обратного-прокси) для добавления HTTPS. При использовании обратного прокси задайте `WHISPER_LISTEN_ADDR=127.0.0.1` в `/etc/whisper/whisper.conf`, чтобы незашифрованный порт не был доступен напрямую.
